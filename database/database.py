...
# ===========================
# MongoDB Client Fix for SSL
# ===========================
# Async Motor client
dbclient = motor.motor_asyncio.AsyncIOMotorClient(
    DB_URI,
    tls=True,
    tlsAllowInvalidCertificates=True,  # Only for dev/testing in Codespaces/Render
    serverSelectionTimeoutMS=20000
)
database = dbclient[DB_NAME]

# ===========================
# Sync PyMongo client (optional)
# ===========================
...
# DB Instance
# ===========================
db = Rohit(DB_URI, DB_NAME)        if data:
